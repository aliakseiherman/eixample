        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_teams_asp_net_users_creator_id",
                        column: x => x.creator_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_teams_asp_net_users_deleter_id",
                        column: x => x.deleter_id,
                        principalTable: "asp_net_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_teams_asp_net_users_modifier_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_teams_deleter_id",
                table: "teams",
                column: "deleter_id");

            migrationBuilder.CreateIndex(
                name: "ix_teams_modifier_id",
                table: "teams",
                column: "modifier_id");
        }
